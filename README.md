...
VectorAlgebra — это библиотека на Ruby, предоставляющая базовые инструменты для работы с векторами и решения задач векторной алгебры в двумерном и трёхмерном пространстве.
